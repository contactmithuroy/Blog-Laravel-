      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="{{ route('website.home') }}" class="text-black h2 mb-0">BAROMON</a>
          </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-4 ml-auto">
            ...
            <ul class="list-unstyled float-left mr-5">
              ...
              <li><a href="{{ route('website.contact') }}">Contuct Us</a></li>
          ...
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                @if($setting->facebook)<a target="blank" href="{{ $setting->facebook }}"><span class="icon-facebook pt-2 pr-2 pb-2 pl-0"></span></a>@endif
                @if($setting->twitter)<a target="blank" href="{{ $setting->twitter }}"><span class="icon-twitter p-2"></span></a>@endif
                @if($setting->instagram)<a target="blank" href="{{ $setting->instagram }}"><span class="icon-instagram p-2"></span></a>@endif
                @if($setting->linkedin)<a target="blank" href="{{ $setting->linkedin }}"><span class="icon-linkedin p-2"></span></a>@endif
                @if($setting->email)<a target="blank" href="{{ $setting->email }}"><span class="icon-google p-2"></span></a>@endif
              </p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 text-center">
            <p>
              ...
              <div>
              Devloped By Mithu Roy on <a href="">Laravel Blog Development</a>
